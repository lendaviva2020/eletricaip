            ...
            >
              <div>
                <p className="font-medium">
                  {t.name} <span className="text-xs text-muted-foreground">({t.plan})</span>
                </p>
              ...
              {t.isActive ? (
                ...
                <Button size="sm" variant="outline" onClick={() => switchTo(t.id)}>
                  Trocar
                </Button>
              )}
            </div>
          ...
          <div className="space-y-2">
            {inviteList
              ...
              .map((i) => (
                <div
                  key={i.id}
                  className="flex items-center justify-between border border-border rounded-md px-4 py-2 text-sm"
                >
                  <div>
