...
function SignupPage() {
  ...
  useEffect(() => { if (user) router.navigate({ to: "/dashboard" }); }, [user]);
  ...
  return <AuthShell title="Criar conta" subtitle="Comece grátis em menos de 60 segundos.">
    ...
    <form onSubmit={handleEmail} className="space-y-3">
      ...
      <Input label="Senha (mín. 6 caracteres)" type="password" value={password} onChange={setPassword} required />
