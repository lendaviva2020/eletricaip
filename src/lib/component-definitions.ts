...
export const QF: ComponentDefinition = {
  code: "QF", name: "Disjuntor termomagnético", category: "protection",
  ...
  params: {
    poles:             { type: "enum",   options: ["1", "2", "3", "4"], default: "3", description: "Número de polos" },
    ratedCurrent:      { type: "number", unit: "A",  default: 100, min: 0.5, max: 6300, group: "Elétrico", description: "Corrente nominal (In)" },
    ratedVoltage:      { type: "number", unit: "V",  default: 400, min: 24, max: 1000, group: "Elétrico" },
    breakingCapacity:  { type: "number", unit: "kA", default: 25,  min: 1, max: 100, group: "Proteção", description: "Icu" },
...
export const QS: ComponentDefinition = {
  code: "QS", name: "Seccionadora", category: "protection",
...
export const DR: ComponentDefinition = {
  code: "DR", name: "Diferencial residual (RCD)", category: "protection",
  ...
  params: {
    ...
    tripTime:     { type: "number", unit: "ms", default: 40, min: 10, max: 300, description: "Tempo de atuação a 5×IΔn" },
...
export const FU: ComponentDefinition = {
  code: "FU", name: "Fusível", category: "protection",
...
export const SPD: ComponentDefinition = {
  code: "SPD", name: "Protetor contra surtos (DPS)", category: "protection",
...
export const KM: ComponentDefinition = {
  code: "KM", name: "Contator", category: "control",
...
export const KA: ComponentDefinition = {
  code: "KA", name: "Relé auxiliar", category: "control",
...
export const FR: ComponentDefinition = {
  code: "FR", name: "Relé térmico de sobrecarga", category: "protection",
...
export const M: ComponentDefinition = {
  code: "M", name: "Motor de indução trifásico", category: "machine",
  ...
  params: {
    ...
    serviceFactor:        { type: "number",              default: 1.15, min: 1, max: 1.5, step: 0.05, group: "Construtivo" },
  },
};

// 10. SS — Soft-Starter
export const SS: ComponentDefinition = {
  code: "SS", name: "Soft-Starter", category: "control",
...
export const VFD: ComponentDefinition = {
  code: "VFD", name: "Inversor de frequência", category: "control",
...
export const TR: ComponentDefinition = {
  code: "TR", name: "Transformador de potência", category: "power",
...
export const PS: ComponentDefinition = {
  code: "PS", name: "Fonte chaveada DC", category: "power",
...
export const PLC: ComponentDefinition = {
  code: "PLC", name: "Controlador lógico programável", category: "control",
  description: "CPU + rack de IO digital/analógico, comunicação Ethernet.",
  norms: ["IEC 61131-3"],
  terminals: [
    ...Array.from({ length: 16 }, (_, i) => ({ id: `DI${i}`, role: "signal" as const, side: "left" as const, io: "in" as const })),
    ...Array.from({ length: 4 },  (_, i) => ({ id: `AI${i}`, role: "signal" as const, side: "left" as const, io: "in" as const })),
    ...Array.from({ length: 16 }, (_, i) => ({ id: `DO${i}`, role: "signal" as const, side: "right" as const, io: "out" as const })),
    ...Array.from({ length: 2 },  (_, i) => ({ id: `AO${i}`, role: "signal" as const, side: "right" as const, io: "out" as const })),
    { id: "ETH", role: "signal", side: "bottom", io: "out", label: "Ethernet" },
  ],
  params: {
    model:         { type: "enum",   options: ["S7-1200", "S7-1500", "M221", "M251", "ControlLogix"], default: "S7-1200" },
...
export const KT: ComponentDefinition = {
  code: "KT", name: "Temporizador (relé)", category: "control",
  ...
  params: {
    function:      { type: "enum", options: ["on-delay", "off-delay", "intervalo"], default: "on-delay" },
...
export const CT: ComponentDefinition = {
  code: "CT", name: "Contador de pulsos", category: "control",
...
export const BC: ComponentDefinition = {
  code: "BC", name: "Banco de capacitores", category: "power",
...
const sensorBase = (code: string, name: string, unit: string, defaults: Partial<Record<string, ParamSpec>>): ComponentDefinition => ({
  code, name, category: "instrument",
...
export const TT_TEMP     = sensorBase("TT", "Transmissor de temperatura", "°C", { rangeMin: { type: "number", unit: "°C", default: -50 }, rangeMax: { type: "number", unit: "°C", default: 200 } });
export const LT_LEVEL    = sensorBase("LT", "Transmissor de nível", "%", {});
export const FT_FLOW     = sensorBase("FT", "Transmissor de vazão", "m³/h", { rangeMax: { type: "number", unit: "m³/h", default: 200 } });

// --------------------------------------------------------------------------
export const COMPONENT_LIBRARY: ComponentDefinition[] = [
  QF, QS, DR, FU, SPD, KM, KA, FR, M, SS, VFD, TR, PS, PLC, KT, CT, BC,
  PT_PRESSURE, TT_TEMP, LT_LEVEL, FT_FLOW,
];

export const COMPONENT_BY_CODE: Record<string, ComponentDefinition> =
  Object.fromEntries(COMPONENT_LIBRARY.map((c) => [c.code, c]));
