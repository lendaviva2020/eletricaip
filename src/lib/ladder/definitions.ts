...
export const LADDER_ELEMENTS: LadderElement[] = [
  element("XIC", "Contatos", "Contato NA", "--| |--", "Passa energia quando bit = TRUE.", {}, "XIC"),
  element("XIO", "Contatos", "Contato NF", "--|/|--", "Passa energia quando bit = FALSE.", {}, "XIO"),
  element("R_TRIG", "Contatos", "Borda positiva", "--|P|--", "TRUE por 1 scan na transicao 0-1.", {}, "ONS"),
  element("F_TRIG", "Contatos", "Borda negativa", "--|N|--", "TRUE por 1 scan na transicao 1-0.", {}, "OSF"),
  ...
  element("TON", "Temporizadores", "TON On Delay", "[TON]", "Atraso na ligacao.", { PT: param("PT", "Preset time", 1000, "ms") }),
  element("TOF", "Temporizadores", "TOF Off Delay", "[TOF]", "Atraso no desligamento.", { PT: param("PT", "Preset time", 1000, "ms") }),
  element("TP", "Temporizadores", "TP Pulse", "[TP]", "Pulso de duracao fixa.", { PT: param("PT", "Preset time", 500, "ms") }),
  element("TONR", "Temporizadores", "TONR Retentivo", "[TONR]", "Temporizador acumulativo.", { PT: param("PT", "Preset time", 1000, "ms") }),
  element("CTU", "Contadores", "CTU Up Counter", "[CTU]", "Contagem crescente.", { PV: param("PV", "Preset value", 10) }),
  element("CTD", "Contadores", "CTD Down Counter", "[CTD]", "Contagem decrescente.", { PV: param("PV", "Preset value", 10) }),
  element("CTUD", "Contadores", "CTUD Up/Down", "[CTUD]", "Contagem bidirecional.", { PV: param("PV", "Preset value", 10) }),
