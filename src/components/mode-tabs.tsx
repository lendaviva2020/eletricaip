...
export function ModeTabs({
  ...
  return (
    <div className="h-11 shrink-0 flex items-end gap-0.5 px-3 border-b border-border bg-panel/40">
      {MODES.map((m) => {
        ...
        return (
          <button
            ...
            className={cn(
              "relative h-9 px-3.5 text-xs font-medium rounded-t-md flex items-center gap-2 transition-all",
      ...
      <div className="ml-auto flex items-center gap-2 pb-2 pr-1 text-[11px] text-muted-foreground">
